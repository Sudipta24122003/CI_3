                        ...
                        <div class="col-8">
                            <div class="card" style="text-shadow: 2px 2px 4px">
                                <div class="card-body" style="box-shadow: 5px 5px 10px">
                                    <h1 class="animate__animated animate__bounce">Add Movie</h1>
                                    <span class="animated-line"></span>
                                    <form action="<?php echo base_url('MovieController/addMovie'); ?>" method="post">
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-sm-9">
                                                ...
                                                <input class="btn btn-primary w-md" type="submit" value="Add Movie">
                                            </div>
                                        </div>
                                    </form>
                                </div>
